    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white px-4 sm:px-6">
          ...
          <p className="text-base sm:text-xl md:text-2xl mb-6 sm:mb-8 max-w-2xl mx-auto opacity-90">
            Discover premium products that transform your lifestyle
          </p>
          <Link href="/shop" className="inline-block bg-white text-black px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105">
            Shop Now
          </Link>
        </div>
      </section>
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-base font-medium transition-colors">
                      Add to Cart
                    </button>
                  </div>
                </div>
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-yellow-400 hover:bg-yellow-500 text-black px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-base font-bold transition-colors">
                      Buy Now
                    </button>
                  </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-xl leading-relaxed mb-6 sm:mb-8 text-blue-100">
